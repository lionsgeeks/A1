...
export default function MilestoneEdit({ milestone }) {
    ...
    const breadcrumbs = [
        ...
        { title: 'Edit', href: `/admin/milestones/${milestone.id}/edit` }
    ]
    ...
    const handleSubmit = (e) => {
        ...
        router.patch(`/admin/milestones/${milestone.id}`, data, {
            onSuccess: () => {
                setProcessing(false)
                showSuccess(
                    'Milestone Updated!',
            ...
            onError: (errors) => {
                ...
                showError(
                    'Update Failed',
                    'There was an error updating the milestone. Please check the form and try again.'
                )
            }
        })
    }
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <PageContainer>
                <PageHeader
                    ...
                    description={`Update milestone: ${milestone.title}`}
                    actions={[
                        {
                    ...
                    <div className="w-full p-6">
                        <form onSubmit={handleSubmit} className="space-y-8">
                            <FormSection
                                ...
                                description="Update the basic information for this milestone"
                            >
